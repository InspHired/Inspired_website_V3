  ...
  return (
    <>
      ...
      <div style={styles.pageWrapper}>
        ...
        {/* Hidden H1 for SEO */}
        <h1 className="sr-only">Contact {companyName} - Get in Touch</h1>
            ...
            <div style={styles.contactGrid} className="Contact-grid">
              ...
              <div style={styles.infoCard}>
                ...
                <div style={styles.infoItem}>
                  ...
                  <a href={`mailto:${info.email || 'info@insphired.co.za'}`} style={styles.infoLink}>
                ...
                <div style={styles.infoItem}>
                  ...
                  <a href={`tel:${info.phone || '+27 XX XXX XXXX'}`} style={styles.infoLink}>
