      ...
      <div className="pillar-stage-card">
        <div className="floating-pillar-item float-1">
          ...
          <div className="pillar-badge">
            <span className="badge-dot teal"></span> Qualifications
          </div>
        </div>
        ...
        <div className="floating-pillar-item float-2">
          ...
          <div className="pillar-badge">
            <span className="badge-dot orange"></span> Biometric Checks
          </div>
        </div>
        ...
        <div className="floating-pillar-item float-3">
          ...
          <div className="pillar-badge">
            <span className="badge-dot yellow"></span> Employment Verification
          </div>
        </div>
        ...
        <div className="floating-pillar-item float-4">
          ...
          <div className="pillar-badge">
            <span className="badge-dot yellow"></span> Employment References
          </div>
        </div>
        ...
        <div className="center-metallic-core">
          ...
          <div className="core-brand-tag">
            ...
            <span className="core-label">Verifications</span>
          </div>
        </div>
      </div>
    </div>
