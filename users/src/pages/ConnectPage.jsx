...
const faqData = [
  { q: "Is InspHired Connect truly free for employers?", a: "Yes. It provides zero-cost job advertising, candidate sourcing databases, and direct shortlisting tools for small businesses, startups, and NGOs across South Africa." },
  { q: "What data communication standards does the platform use?", a: "Our system is engineered to comply fully with standard universal HR-XML configurations, enabling data syndication with social networks and external job directories." },
  { q: "How is candidate security managed?", a: "Job seekers register using unique identification profiles and encrypted credentials, featuring smooth CV upload structures for clean user onboarding." }
];

const audienceItems = [
  { title: "Small Businesses", text: "Create listings smoothly with no recruitment background required." },
  { title: "HR Teams", text: "Maintain high shortlisting volumes free from rigid budget limitations." },
  { title: "Startups & NGOs", text: "Build dynamic social frameworks without high agency placement margins." },
  { title: "Job Seekers", text: "Secure clean personal profiles and apply instantly for free." },
];

const features = [
  { title: "Free sourcing channels", text: "Launch professional, public vacancy listings rapidly. Build specialized in-house candidate databases without upfront billing structures.", icon: "fa-bullhorn", accent: "var(--teal)" },
  { title: "HR-XML standardization", text: "Engineered securely alongside robust global HR data paradigms. Aggregates multi-channel postings directly with decentralized networks and directories.", icon: "fa-code", accent: "var(--orange)" },
  { title: "Applicant communication", text: "Leverage automated communication arrays. Issue immediate context notices, group shortlist triggers, or bulk regret templates right from the main dashboard views.", icon: "fa-comments", accent: "var(--yellow)" },
  { title: "Secure data controls", text: "Maintains structural integrity and security controls via localized automatic database backup systems, providing business continuity assurances.", icon: "fa-server", accent: "var(--navy)" },
];
  ...
  return (
    <div style={styles.pageWrapper}>
      <style>{`
        ...
        .gift-bounce { animation: giftBounce 2s ease-in-out infinite; }
          ...
          <div style={styles.heroGrid} className="animate-fadeup">
            <div>
              ...
              <p style={styles.heroLead}>
                A free-to-use digital job board and e-recruitment CRM engineered to democratize access to career
                opportunities across Southern Africa for employers and candidates alike.
              </p>
              <div style={styles.btnRow}>
                <a href="https://connect.insphired.jobs" target="_blank" rel="noreferrer" style={styles.btnPrimary} className="btn-hover-transition">
            ...
            <div style={styles.heroVisualWrap}>
              <div style={styles.orbitRing}>
                ...
                <div style={{ ...styles.glassCard, textAlign: 'center' }}>
                  <div style={styles.iconContainer} className="gift-bounce">
                    <i className="fas fa-gift" style={styles.heroCardIcon} aria-hidden="true"></i>
                  </div>
                  <h3 style={styles.heroCardTitle}>Post for free</h3>
                  <p style={styles.heroCardText}>Professional-grade e-recruitment tools with zero baseline cost overhead.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={styles.sectionWhite}>
        <div style={styles.container}>
          <div style={styles.splitRow}>
            <div>
              <span style={styles.sectionTag}>Our shared purpose</span>
              <h2 style={styles.sectionHeading}>Breaking barriers to employment</h2>
              <p style={styles.bodyText}>
                We believe job visibility, candidate shortlisting, and hiring logic shouldn't carry steep price barriers for emerging businesses.
              </p>
              <div style={styles.quoteBlock}>
                "To simplify job posting and discovery through a powerful, user-friendly platform that supports employers with recruitment technology and helps candidates find meaningful work, fast."
              </div>
            </div>
            <div style={styles.audienceCard}>
              <h4 style={styles.audienceHeading}>Target ecosystem audience</h4>
      ...
      <section style={styles.sectionLight}>
        <div style={styles.container}>
          <div style={styles.centerHead}>
            <span style={styles.sectionTag}>Operational logic</span>
            <h2 style={styles.sectionHeading}>Core platform foundations</h2>
          </div>
      ...
      <section style={styles.sectionWhite}>
        <div style={styles.container}>
          <div style={styles.centerHead}>
            <span style={styles.sectionTag}>Clear answers</span>
...
const styles = {
  ...
  appLogo: { width: '72px', height: '72px', objectFit: 'contain', filter: 'drop-shadow(0 4px 12px rgba(80, 155, 158, 0.3))' },
